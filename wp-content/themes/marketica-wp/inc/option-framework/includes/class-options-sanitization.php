...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'tokopress' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'tokopress' ),
		'repeat-y'  => __( 'Repeat Vertically', 'tokopress' ),
		'repeat'    => __( 'Repeat All', 'tokopress' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'tokopress' ),
		'top center'    => __( 'Top Center', 'tokopress' ),
		'top right'     => __( 'Top Right', 'tokopress' ),
		'center left'   => __( 'Middle Left', 'tokopress' ),
		'center center' => __( 'Middle Center', 'tokopress' ),
		'center right'  => __( 'Middle Right', 'tokopress' ),
		'bottom left'   => __( 'Bottom Left', 'tokopress' ),
		'bottom center' => __( 'Bottom Center', 'tokopress' ),
		'bottom right'  => __( 'Bottom Right', 'tokopress')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'tokopress' ),
		'fixed'  => __( 'Fixed in Place', 'tokopress')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'tokopress' ),
		'italic'      => __( 'Italic', 'tokopress' ),
		'bold'        => __( 'Bold', 'tokopress' ),
		'bold italic' => __( 'Bold Italic', 'tokopress' )
		);
