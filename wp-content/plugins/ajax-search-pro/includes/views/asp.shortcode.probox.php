...
<div class="probox">
    ...
    <div class='promagnifier'>
	    ...
	    <div class='asp_text_button<?php echo w_isset_def($style['display_search_text'], 0) == 1 ? "" : " hiddend"; ?>'>
		    <?php
		    echo w_isset_def($style['search_text'], "");
		    ?>
	    </div>
    ...
    <div class='proinput<?php echo w_isset_def($style['box_compact_layout'], 0)==1?' hiddend':''; ?>'>
        <form action='#' autocomplete="off">
            <input type='search' class='orig' placeholder='<?php echo asp_icl_t( "Search bar placeholder text", w_isset_def($style['defaultsearchtext'], '') ); ?>' name='phrase' value='<?php echo get_search_query(); ?>' autocomplete="off"/>
