...
include(ASP_PATH."/backend/settings/functions.php");
...
include('class/textarea-base64.class.php');
...
if (!function_exists("admin_scriptsV04")) {
  function admin_scriptsV04() {
    ...
    wp_enqueue_media(); // For image uploader.
  	...
  	wp_register_script('wpdreams-types', plugin_dir_url(__FILE__) . '/assets/types.js');
    wp_enqueue_script('wpdreams-types', array('jquery', 'jquery-ui-sortable', 'farbtastic'));
    ...
    wp_register_script('wpdreams-ui-datetimepicker', plugin_dir_url(__FILE__) . '/assets/js/ui/jquery.ui.datetimepicker.js', array(
    ...
    wp_enqueue_script('wpdreams-tabs');
  	wp_register_script('wpdreams-base64', plugin_dir_url(__FILE__) . '/assets/base64.js', array(
  		'jquery'
  	));
    wp_enqueue_script('wpdreams-base64');
    ...
    wp_enqueue_script('wpdreams-fonts-jsapi');
      ...
      // Bootstrap Validator
      /*wp_register_script('wpdreams-parsley', plugin_dir_url(__FILE__) . '/assets/js/validator/parsley.min.js', array(
          'jquery'
      ));
      wp_enqueue_script('wpdreams-parsley');*/
...
if (!function_exists("admin_stylesV04")) {
  function admin_stylesV04() {
    ...
    wp_enqueue_style('wpdreams-accordion');
      ...
      wp_register_style('wpdreams-validator', plugin_dir_url(__FILE__) . '/assets/validator.min.css');
